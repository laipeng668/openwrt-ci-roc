...
## 仓库说明
- 本人 Fork 的仓库：[OpenWrt] [ImmortalWrt] [LibWrt]，内容大体一致。
...
- 编译大概需要 1-2 小时，编译完成后在仓库主页 [Releases](https://github.com/wjt12300/openwrt-ci-roc/releases) 对应 [Tag](https://github.com/wjt12300/openwrt-ci-roc/tags)标签内下载固件。
